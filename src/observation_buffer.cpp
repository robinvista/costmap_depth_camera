...
ObservationBuffer::ObservationBuffer(string topic_name, double observation_keep_time, double expected_update_rate,
                                     ...
                                     double raytrace_range, tf::TransformListener& tf, string global_frame,
...
bool ObservationBuffer::setGlobalFrame(const std::string new_global_frame)
{
  ...
  // if (!tf_.canTransform(new_global_frame, global_frame_, transform_time, ros::Duration(tf_tolerance_), &tf_error))
...
void ObservationBuffer::bufferCloud(const sensor_msgs::PointCloud2& cloud)
{
  ...
  try
  {
    ...
    */
    ...
    pcl_ros::transformPointCloud(global_frame_, *observation_list_.front().frustum_, *observation_list_.front().frustum_, tf_);
    ...
    */
    ...
    // tf_.transform(cloud, global_frame_cloud, global_frame_);
